<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700 z-[80]">
    <!-- Primary Navigation Menu -->
    <div class="w-full px-4 mx-auto sm:px-6 lg:px-6">
        <div class="flex justify-between h-16 lg:ps-64">
            <div class="flex">
                {{-- <!-- Logo -->
...
<header x-data="{ open: false }"
    class="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-white text-sm py-2.5 sm:py-4 lg:ps-64 dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100">
